...
- 阶段：8（完成）；此后为常规迭代，当前版本 **v1.5.2**（2026-09-11 已发布：
  <https://github.com/quexing65/workbench/releases/tag/v1.5.2>）。
...
- 阶段 8 全部完成；v1.0.0 于 2026-08-21 上线，此后迭代至 v1.5.2（2026-09-11 发布）。
